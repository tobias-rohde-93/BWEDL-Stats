...
assert.equal(currentCacheName, 'bwedl-dashboard-v43');
...
(async () => {
    ...
    assert.ok(installedAssets.includes('./style.css?v=9'));
    ...
    assert.ok(installedAssets.includes('./bundle_v31.js?v=4.0'));

...
assert.equal(currentCacheName, 'bwedl-dashboard-v44');
...
(async () => {
    ...
    assert.ok(installedAssets.includes('./style.css?v=10'));
    ...
    assert.ok(installedAssets.includes('./bundle_v31.js?v=4.1'));

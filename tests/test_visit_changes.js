...
assert.equal(lifecycle.render(fakeDocument, dashboard), null, 'one lifecycle never renders or persists twice');
assert.deepEqual(lifecycleEvents, ['build', 'get', 'render', 'set']);
...
for (const storage of [
    ...
    assert.doesNotThrow(() => failedStorageLifecycle.render(fakeDocument, new FakeElement('main')));
}
